    ...
    <div className="min-h-screen bg-gradient-to-b from-indigo-900 to-purple-900 text-white">
      ...
      <header className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="z-10 text-center">
          ...
          <Link href={'/render'}>    Discover Your Zodiac</Link>
          </Button>
        </div>
      </header>
      ...
      <section className="bg-purple-800 py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12">Today`&lsquo;`s Celestial Forecast</h2>
      ...
      <section className="py-16 px-4 text-center">
        ...
        <Button size="lg" className="bg-yellow-500 text-purple-900 hover:bg-yellow-400">
         <Link href={'/render'}> Get Your Personal Reading</Link>
        </Button>
      </section>
    </div>
  )
